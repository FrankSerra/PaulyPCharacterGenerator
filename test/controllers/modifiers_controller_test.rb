...
class ModifiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modifier" do
    assert_difference('Modifier.count') do
      post modifiers_url, params: { modifier: { name: @modifier.name, replacewithshape: @modifier.replacewithshape } }
    end
  ...
  test "should update modifier" do
    patch modifier_url(@modifier), params: { modifier: { name: @modifier.name, replacewithshape: @modifier.replacewithshape } }
