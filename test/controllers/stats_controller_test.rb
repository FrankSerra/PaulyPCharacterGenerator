...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { maxval: @stat.maxval, minval: @stat.minval, name: @stat.name } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { maxval: @stat.maxval, minval: @stat.minval, name: @stat.name } }
